...
var vec__11608 = module$node_modules$react$index.useState(initial);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11608,(0),null);
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11608,(1),null);
var updater = module$node_modules$react$index.useCallback((function() { 
var G__11644__delegate = function (x,xs){
...
var G__11612 = (function helix$hooks$use_state_$_spread_updater(y){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(x,y,xs);
});
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__11612) : u.call(null,G__11612));
} else {
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
}
};
var G__11644 = function (x,var_args){
var xs = null;
if (arguments.length > 1) {
var G__11645__i = 0, G__11645__a = new Array(arguments.length -  1);
while (G__11645__i < G__11645__a.length) {G__11645__a[G__11645__i] = arguments[G__11645__i + 1]; ++G__11645__i;}
  xs = new cljs.core.IndexedSeq(G__11645__a,0,null);
} 
return G__11644__delegate.call(this,x,xs);};
G__11644.cljs$lang$maxFixedArity = 1;
G__11644.cljs$lang$applyTo = (function (arglist__11646){
var x = cljs.core.first(arglist__11646);
var xs = cljs.core.rest(arglist__11646);
return G__11644__delegate(x,xs);
});
...
if((ref.current == null)){
(ref.current = (function (){var x11615 = ({"current": x});
(x11615.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x11615.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x11615.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x11615.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",v);
}));

(x11615.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x11615.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__11616 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__11616) : f.call(null,G__11616));
})());
}));

(x11615.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__11617 = this$__$1.current;
var G__11618 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__11617,G__11618) : f.call(null,G__11617,G__11618));
})());
}));

(x11615.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__11619 = this$__$1.current;
var G__11620 = a;
var G__11621 = b;
...
(x11615.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
 ...
 */
helix.hooks.use_subscription = (function helix$hooks$use_subscription(p__11637){
var map__11638 = p__11637;
var map__11638__$1 = cljs.core.__destructure_map(map__11638);
var get_current_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11638__$1,new cljs.core.Keyword(null,"get-current-value","get-current-value",-1706578691));
var subscribe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11638__$1,new cljs.core.Keyword(null,"subscribe","subscribe",416253756));
var vec__11639 = module$node_modules$react$index.useState((function (){
...
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11639,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11639,(1),null);
...
return (set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__11642) : set_state.call(null,G__11642));
} else {
return null;
}
});
...
var value = (get_current_value.cljs$core$IFn$_invoke$arity$0 ? get_current_value.cljs$core$IFn$_invoke$arity$0() : get_current_value.call(null));
var G__11643_11658 = ({"get-current-value": get_current_value, "subscribe": subscribe, "value": value});
(set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__11643_11658) : set_state.call(null,G__11643_11658));
