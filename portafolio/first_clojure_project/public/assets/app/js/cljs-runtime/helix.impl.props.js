...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__11727_SHARP_,p2__11726_SHARP_){
return p2__11726_SHARP_.toUpperCase();
}));
...
var G__11728 = o;
helix.impl.props.goog$module$goog$object.set(G__11728,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__11755 = cljs.core.rest(m);
var G__11756 = (function (){var entry = cljs.core.first(m);
...
var G__11732 = o1;
helix.impl.props.goog$module$goog$object.extend(G__11732,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11734_SHARP_){
if(cljs.core.map_QMARK_(p1__11734_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__11734_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__11791 = cljs.core.rest(m);
var G__11792 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__11795 = cljs.core.rest(m);
var G__11796 = (function (){var entry = cljs.core.first(m);
